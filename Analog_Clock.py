...
pygame.draw.circle(screen,white,(pos_x,pox_y).radius,6)

#draw the clock numbers 1-12
for n in range(1,13):
    angle = math.randians(n*(360/12)-90)
...
#draw the hours hand
hour_angle = wrap_angle(hours*(160/12)-90)
hour_angle = math.radians(hour_angle)
hour_x = math.cos(hour_angle)*(radius-80)
hour_x =math.sin(hour_angle)*(radius-80)
